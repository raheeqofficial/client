...
const MyList = () => {
    ...
    return (
        ...
        <Helmet>
          ...
          <meta
  name="description"
  content="Save your favorite products for later and keep track of the items you love at Hibuyshopping. Easily manage your Wishlist and shop your saved items anytime."
/>
