            ...
            <div className="terms-container">
              <div className="">
                ...
                <div className="terms-body">
                  <h4>
                    <strong>
                      At Hibuyshopping.com, we prioritize your privacy and are
                      committed to protecting your personal information. This
                      Privacy Policy outlines how we collect, use, disclose, and
                      safeguard your data when you visit our website or make a
                      purchase. By using our website, you agree to the
                  ...
                  <div>
                    <p>
                      <b>1. Personal Information</b>: When you register on our
                      site, place an order, subscribe to our newsletter, or fill
                      out a form, we may collect the following personal
                      information:
                      <ul>
                        <li>
                          <b>i.</b> Name
                        ...
                        <li>
                          <b>ii.</b> Email address
                        </li>
                        <li>
                          <b>iii.</b> Phone number
                        </li>
                        <li>
                          <b>iV.</b> Payment details (credit card information,
                          billing address)
                        </li>
                        <li>
                          <b>V.</b> Shipping address
                        </li>
                      </ul>
                    </p>
                  </div>
                  <div>
                    <p>
                      <b>2. Non-Personal Information</b>: We may also collect
                      ...
                      <ul>
                        ...
                        <li>
                          <b>iii.</b> Browsing behavior (pages visited, time
                          spent on site, clicks)
                        </li>
                      </ul>
                    </p>
                  </div>
                  ...
                  <p>
                    ...
                    <div>
                      <p>
                        <b>1. Process Transactions</b>: Your personal
                        information will be used to process your orders and
                        deliver the products you purchase.
                      </p>
                      <p>
                        <b>2. Improve Our Website</b>: We continually strive to
