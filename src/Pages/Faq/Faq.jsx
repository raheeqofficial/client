          ...
          <div className="container">
            ...
            <div className="accordianBox mb-1 mt-1">
              <Accordion>
                ...
                <AccordionDetails>
                  A: To create an account, click on the "Sign Up" button on the
                  top right corner of our homepage. Fill in the required
                  details, including your email address, password, and personal
                  information. Once registered, you can start shopping and
            ...
            <div className="accordianBox mb-1 mt-1">
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  ...
                  website. <br /> 2.<b>Find the Order Cancellation Option</b> : Look
                  for the order cancellation section. <br /> 3.
                  <b>Submit Your Request: </b> : Provide the necessary details
                  about your order and submit your cancellation request.
                  <br /><br />
                   Please
                  note: Once an order is confirmed, it cannot be altered or
                  canceled. Ensure you review your order details carefully
                  before finalizing to avoid any issues.
                  <br /><br />
            ...
            <div className="accordianBox mb-1 mt-1">
              ...
              <Accordion>
                ...
                <AccordionDetails>A: Delivery times vary based on your location and the shipping method selected. Standard shipping typically takes 5-7 business days, while expedited shipping takes 2-3 business days.</AccordionDetails>
              </Accordion>
              <Accordion>
                <AccordionSummary
                  expandIcon={<ExpandMoreIcon />}
                ...
                <AccordionDetails>
                  A: Yes, once your order is confirmed, you can track your order. Simply follow these steps: 
                  <br />
                  1.
                  <b>Visit the Help Center</b> : Go to our Help Center on the
              ...
              <Accordion>
                ...
                <AccordionDetails>A: Yes, we offer international shipping to many countries. 
                    Shipping fees and delivery times vary depending on the destination.
                    <br /><br />
                    If you need further assistance, feel free to contact our customer service team(support@hibuyshopping.com).
                    </AccordionDetails>
              </Accordion>
            </div>
            ...
            <div className="accordianBox mb-1 mt-1">
              ...
              <Accordion>
                ...
                <AccordionDetails>
                  A: You can return your order through our Help Center within 7 days. Simply follow these steps: 
                  <br />
                  1.
                  <b>Visit the Help Center</b> : Go to our Help Center on the
                  ...
                  <br /><br />
                  For returns, please be aware that your return request will only be accepted if your order is delivered within the last 7 days. After this period, we will not be able to process return requests.
                  <br /><br />
                  If you need further assistance, feel free to contact our
                  customer service team.
                </AccordionDetails>
              ...
              <Accordion>
                ...
                <AccordionDetails>A: Yes, we offer exchanges for defective or damaged items. Please contact us within 7 days of receiving the item to initiate the exchange process.</AccordionDetails>
              </Accordion>
              <Accordion>
                <AccordionSummary
                  expandIcon={<ExpandMoreIcon />}
                ...
                <AccordionDetails>A: Refunds are processed within 7-10 business days after we receive the returned item. The refund will be credited to your original payment method.</AccordionDetails>
              </Accordion>
            </div>
          </div>
        </div>
